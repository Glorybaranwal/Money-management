    ...
    return (
      <div className="flex flex-wrap justify-center gap-4 mt-4">
        {payload.map((entry: any, index: number) => {
          ...
          if (category === "shopping") icon = <ShoppingBag className="h-4 w-4" />
          else if (category === "food") icon = <Utensils className="h-4 w-4" />
          else if (category === "transport") icon = <Car className="h-4 w-4" />
          else if (category === "entertainment") icon = <Music className="h-4 w-4" />
